...
- [Zotero Companion](./apps/zotero/CONTEXT.md) — the Zotero-side add-on: what it observes in Zotero, and how it keeps Zotero's database readable by the Obsidian plugin
