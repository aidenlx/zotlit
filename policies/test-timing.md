...
- **Clocks:** Drive time-dependent behavior with fake time. Attach rejection assertions before advancing it. Advance once past a known deadline; poll only for an arrival whose time the test cannot name.
