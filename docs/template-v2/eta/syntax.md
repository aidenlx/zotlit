...
This is the Eta syntax reference for users who have enabled [JavaScript Templates](../javascript-templates.md). If you're using the default template engine, see the top-level [Syntax](../syntax.md) for the Liquid equivalent.
