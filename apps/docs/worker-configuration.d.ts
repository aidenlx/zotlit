/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ed7c08a2fa8c416caca039d6ef5e1d4)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DOCS_LINE: "beta" | "production";
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOCS_LINE" | "GITHUB_TOKEN">> {}
}
