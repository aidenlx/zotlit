...
The companion adds these entry points in Zotero. Right-click a single item, open the **ZotLit** submenu, and select **Explore Template Data**. Zotero opens the explorer in Obsidian via a protocol link.
