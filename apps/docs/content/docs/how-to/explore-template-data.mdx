...
## Copy an Indexed Key [#indexed-key]

An Indexed Key names one Zotero object: an item, an attachment, an annotation, or a note. Copy one when a tool asks you which object to work on.
