...
The order of fields in the Frontmatter list determines the order of frontmatter keys when ZotLit creates a new literature note. On a new note, system fields (`zotero-key` and `citekey`) follow the user-configured fields.
