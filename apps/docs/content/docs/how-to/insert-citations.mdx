...
With **Citation key indexing** and **Citation key styling** on, both forms receive the citation treatment. Live Preview and reading view show formatted citation text.

In Live Preview, click a citation to open or create its Literature Note. In Source mode, use Ctrl-click or Cmd-click. A plain click places the caret. See [How citation display and navigation work](/docs/concepts/how-citekey-links-work).
