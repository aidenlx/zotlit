...
With **Citation key styling** on, both forms are clickable in Live Preview and Source mode, and both show their formatted citation text in Live Preview and reading view. See [How citation key styling works](/docs/concepts/how-citekey-links-work).
