...
Only the bracketed primary form becomes a clickable [citekey link](/docs/concepts/how-citekey-links-work) in the editor. The default secondary form is bare, so it stays plain text.
