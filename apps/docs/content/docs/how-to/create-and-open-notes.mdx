...
description: "Open or create a literature note with the quick switcher, a citation key click, or the Zotero menu."
---
...
**Citation key styling** in **Settings → ZotLit → Citations** adds display and navigation to citation keys. It is on by default, and takes effect while **Citation key indexing** is also on.
...
- In reading view, click a formatted citation. A multi-work citation opens a menu.

You can also place the cursor on a recognized key and run <Command inline>ZotLit: Open citation key under cursor</Command>. The command is available while **Citation key indexing** and **Citation key styling** are on.
...
For the recognized syntax, modifiers, hover preview, and other opening commands, see [How citation display and navigation work](/docs/concepts/how-citekey-links-work).
