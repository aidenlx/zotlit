...
description: "Open or create a literature note from a Zotero item using the quick switcher, a clickable citation key, or the Zotero right-click menu for bulk operations."
---
...
When you type or paste a bracketed citation like `[@key]` in the editor, ZotLit makes the citation key clickable. Click it to open or create the corresponding literature note.
...
Citation key clicks resolve against the **Default library** setting at the top of **Settings > ZotLit**. For details on how citation key links work under the hood, including hover preview and the Reading mode limitation, see [How citation key links work](/docs/concepts/how-citekey-links-work).
