...
**Open citations as links** covers Literature Note wikilinks shown as citations as well. For recognized syntax and the complete interaction model, see [How in-text citation rendering and navigation work](/docs/concepts/how-citekey-links-work).

## Find notes that cite a Literature Note

Open the Literature Note whose incoming citations you want to inspect. Run:

<Command>ZotLit: Show cited by</Command>
