...
To update every note in your library at once, run <Command inline>ZotLit: Create or update all literature notes</Command> from the Obsidian command palette. This skips the Zotero selection step and processes the entire library.
