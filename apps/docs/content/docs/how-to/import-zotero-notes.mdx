...
If an attachment was skipped because its folder was not approved, a notice lists the blocked source folder. Select **Open ZotLit settings**, open **Attachments → Approved folders**, and approve the folder if you trust it. Then re-import the note to copy the attachment. Approval applies to future imports and does not update earlier imports automatically.
