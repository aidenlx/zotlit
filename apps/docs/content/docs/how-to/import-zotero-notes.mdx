...
The Obsidian command covers every library in your **Library scope** (set in **Settings > ZotLit**). The Zotero entries cover the library or collection you right-clicked, whatever your library scope is. If the collection no longer exists in your Zotero database, Obsidian reports "Collection not found in Zotero."
