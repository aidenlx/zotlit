...
Your saved scope is untouched. See [Fix stale data from Zotero](/docs/how-to/fix-stale-data) for the connection itself.
...
Both settings can be off. ZotLit's internal Citation Index remains active, and **Reset citation index** remains available under Diagnostics.
