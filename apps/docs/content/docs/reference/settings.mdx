...
| Label                  | Key                           | Control | Default |
| ---------------------- | ----------------------------- | ------- | ------- |
| **Citekey indexing**   | `citation.citekey-indexing`   | Toggle  | On      |
| **Wikilink citations** | `citation.wikilink-citations` | Toggle  | Off     |

**Citekey indexing** tracks Pandoc citation keys such as `@doe2024` across your vault, so ZotLit knows which items each note cites. Keys inside code, math, comments, and frontmatter are ignored.
