...
| **Open Pandoc citations as links** | `citation.open-pandoc-links` | Toggle  | On      | **Pandoc citations** is on and the cursor or pointer is on a recognized Pandoc citation | Synced  |
...
**Open Pandoc citations as links:** Open and preview literature notes from Pandoc citations. This setting does not change how citations are shown.

The navigation setting also controls the four open-under-cursor commands. Literature Note wikilinks retain Obsidian's navigation.
