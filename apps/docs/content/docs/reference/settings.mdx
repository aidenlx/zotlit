...
**Citation key styling** styles citation keys such as `@doe2024` in the editor, and opens the literature note of a key when you click it. In reading view, citations show their formatted text. See [How citation key styling works](/docs/concepts/how-citekey-links-work).
