...
Both note properties are set from the **ZotLit: Set citation presentation** command, which is also in the note's **More options** menu. See [Commands](/docs/reference/commands).
