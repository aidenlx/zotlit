...
This page documents the Eta template language as configured in ZotLit. Eta templates require the [JavaScript Templates gate](/docs/how-to/enable-javascript-templates) to be enabled. For the default Liquid engine, see [Template syntax](/docs/reference/templates/syntax).
