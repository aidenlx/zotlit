...
- **Settings > Templates** shows a warning: "The Eta template at `{path}` is inactive because JavaScript templates are disabled on this device."
...
<Cards>
  ...
  <Card
    ...
    description="Full option list including the JavaScript templates setting."
