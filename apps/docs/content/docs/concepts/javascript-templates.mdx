...
that controls whether Eta templates (`.eta.md` files) compile and execute. It is
disabled by default.
...
- <SettingsPath /> shows a warning: "The Eta template at `{path}` is inactive
  because JavaScript templates are disabled on this device."
