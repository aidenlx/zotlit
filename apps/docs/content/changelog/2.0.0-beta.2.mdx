...
- Context-menu labels in ZotLit Companion, the Zotero add-on, now say "Literature Note" instead of bare "note", and adopt Title Case to match Zotero's own menus.
