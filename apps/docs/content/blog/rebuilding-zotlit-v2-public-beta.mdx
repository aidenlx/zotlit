...
ZotLit Companion, the Zotero add-on, targets Zotero 9, whose API has settled enough to build against without chasing a moving target.
...
<ActionLink href="/docs/tutorial/first-note" kind="external">
