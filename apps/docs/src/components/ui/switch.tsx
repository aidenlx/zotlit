  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-5 rounded-full bg-fd-background shadow-sm data-checked:translate-x-5 rtl:data-checked:-translate-x-5 data-unchecked:translate-x-0.5 rtl:data-unchecked:-translate-x-0.5"
      />
    </SwitchPrimitive.Root>
  );
}
