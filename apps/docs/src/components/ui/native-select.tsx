  ...
  return (
    ...
    >
      <select
        ...
        data-size={size}
        className="min-h-10 w-full min-w-0 appearance-none rounded-md border border-fd-border bg-fd-card py-2 ps-3 pe-9 text-base hover:bg-fd-muted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fd-ring disabled:cursor-default aria-invalid:border-fd-foreground data-[size=sm]:min-h-9 data-[size=sm]:py-1.5 sm:text-sm"
        {...props}
      />
      <ChevronDown
        aria-hidden
