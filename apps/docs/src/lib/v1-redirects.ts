// Redirect table for the Cloudflare asset layer, expanded from the
...
// invocation. The `_headers` file is lib/headers.ts.
//
...
import { zotlitLegacyUrl } from "./shared.js";
import { PAGE_MAP, V1_ONLY } from "./v1-routes.js";
