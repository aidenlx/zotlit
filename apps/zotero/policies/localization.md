...
- Menu labels name the **Literature Note** / **Imported Note** vocabulary (see `apps/obsidian/GLOSSARY.md`), never bare "note". Entries inside the ZotLit submenu omit "in Obsidian" — the submenu scopes them; entries appended flat to Zotero's own menus keep it.
