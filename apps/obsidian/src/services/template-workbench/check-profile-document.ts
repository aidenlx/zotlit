...
// entry module keeps request parsing, Check Attempt retention, and answer
// assembly, and hands this branch every input it reads.
...
import type { InspectedSource, ProfileCheckBranch } from "./check";
...
export async function checkProfileDocument({
  ...
  attachReport,
  finish,
}: ProfileCheckBranch): Promise<string> {
