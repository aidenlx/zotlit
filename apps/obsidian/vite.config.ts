  ...
  return {
    ...
    plugins: [
      obsidianI18n({
        ...
        // Companion copy lives under `zotero.`; the settings descriptions
        // that quote a Companion label name the exact messages they need.
        excludeMessagePrefixes: ["docs_", "zotero."],
        includeMessages: COMPANION_MESSAGES,
