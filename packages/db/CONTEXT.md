...
Public English documentation and user-facing copy call this a **Zotero key**; Chinese copy uses **Zotero 标识符**. Both are distinct from the **Citation Key** (`citekey`). Use **Indexed Key** for the internal domain term.
